...
Frischer Clone + neues Supabase-Projekt + dokumentierte Env-Vars kann: `schema.sql` ausführen, GR-Behörden seeden (real, nicht `is_test`), `npm run dev`, einen Report einreichen (Geofence greift), Foto wird anonymisiert, moderieren, **echt